...
function createUserModal(user) {
  ...
  userSession.addEventListener("click", async () => {
    ...
    toastBody.innerText = `${user.firstName} ${user.lastName} is now in UserMode User ID: ${user.id}`;
